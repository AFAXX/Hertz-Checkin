-- AlterTable: add timestamp & geolocation to PhotoSubmission
ALTER TABLE "PhotoSubmission" ADD COLUMN "capturedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP;
